...
# Slide 3 — Image 1
add_image_slide("RAG Flow Diagram", "/mnt/data/SimpleRAG.png", "Query embedding, retrieval, context, and generation.")

# Slide 4 — Image 2
add_image_slide("Document Chunking & Vector Flow", "/mnt/data/RAG_flow.png", "Flow from raw docs to chunks to embeddings to vector DB.")
